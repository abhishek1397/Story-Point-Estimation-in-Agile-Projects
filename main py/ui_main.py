...
"")
        ...
        self.credit.setMinimumSize(QtCore.QSize(0, 40))
        self.credit.setMaximumSize(QtCore.QSize(16777215, 78))
        ...
        self.pushButton_login_back = QtWidgets.QPushButton(self.credit)
        (self.pushButton_login_back).clicked.connect(lambda:MainWindow.hide()) ####################################333333333//////////////////
        self.pushButton_login_back.setMinimumSize(QtCore.QSize(150, 20))
        self.pushButton_login_back.setMaximumSize(QtCore.QSize(150, 29))
        self.pushButton_login_back.setStyleSheet("QPushButton{ \n"
"    border:5px sold rgb(60,231,195);\n"
...
"} ")
        ...
        self.pushButton_exit.setMinimumSize(QtCore.QSize(150, 20))
        self.pushButton_exit.setMaximumSize(QtCore.QSize(150, 29))
...
"Story Point"))
        self.pushButton_cus_train.setText(_translate("MainWindow", "Model\n"
"Training& Testing"))
        self.pushButton_login_back.setText(_translate("MainWindow", "Back to login page"))
